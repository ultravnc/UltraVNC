...
DirExistsWarning=no
OutputDir=setupfile
OutputBaseFilename=UltraVNC_{#MyAppOutputVersion}_X64_Setup
UserInfoPage=false
...
Name: "installDriver"; Description: "{cm:AddVirtualMonitorDriverWin10}"; MinVersion: 0,6.2; Components: UltraVNC_Server ;Flags: unchecked
...
Source: "encryptionplugins\xp\64\SecureVNCPlugin64.dsm"; DestDir: "{app}"; Flags: ignoreversion replacesameversion restartreplace; MinVersion: 0,5.01; Components: UltraVNC_Viewer UltraVNC_Server
...
Source: "64\xp\sas.dll"; DestDir: "{app}"; Flags: ignoreversion replacesameversion restartreplace; MinVersion: 0,6.0.6000; OnlyBelowVersion: 0,6.1.7600; Components: UltraVNC_Server
...
Name: "{group}\UltraVNC Viewer\UltraVNC Viewer (Listen Mode Encrypt))"; Filename: "{app}\vncviewer.exe"; WorkingDir: "{app}"; Parameters: "-dsmplugin SecureVNCPlugin64.dsm -listen 5500"; Components: UltraVNC_Viewer
...
Filename: "http://www.uvnc.com/downloads/ultravnc.html"; Flags: nowait postinstall shellexec runasoriginaluser skipifsilent; Description: "{cm:ShowLatestVersions}"

[UninstallRun]
Filename: "{sys}\pnputil.exe"; Parameters: "/delete-driver ""{app}\UVncVirtualDisplay64\UVncVirtualDisplay.inf"" /uninstall"; WorkingDir: "{app}\UVncVirtualDisplay64"; Flags: 64bit runhidden; StatusMsg: "{cm:UninstallingVirtualDriver}"
