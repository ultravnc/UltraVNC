...
[UninstallRun]
Filename: "pnputil.exe"; Parameters: "/delete-driver ""{app}/UVncVirtualDisplay\UVncVirtualDisplay.inf /uninstall"; Flags: runhidden; StatusMsg: "{cm:UninstallingVirtualDriver}"
