...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR szCmdLine, int iCmdShow)
{
  ...
  char optionsFile[MAX_PATH];
  char savedLanguage[32] = "en";  // Default to English
  
  // Try to find and load options file
  strcpy_s(optionsFile, szCurrentDir);
  strcat_s(optionsFile, "\\options.vnc");
  
  // Check if file exists and read language setting
  HANDLE hFile = CreateFile(optionsFile, GENERIC_READ, FILE_SHARE_READ, NULL, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, NULL);
  if (hFile == INVALID_HANDLE_VALUE) {
	  // Try AppData folder
	  if (SHGetFolderPath(0, CSIDL_APPDATA, NULL, SHGFP_TYPE_CURRENT, optionsFile) == S_OK) {
		  strcat_s(optionsFile, "\\UltraVNC\\");
		  strcat_s(optionsFile, "options.vnc");
		  hFile = CreateFile(optionsFile, GENERIC_READ, FILE_SHARE_READ, NULL, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, NULL);
	  }
  }
  ...
  if (hFile != INVALID_HANDLE_VALUE) {
	  ...
	  GetPrivateProfileString("options", "language", "en", savedLanguage, sizeof(savedLanguage), optionsFile);
  }
  ...
  if (_stricmp(savedLanguage, "en") != 0) {
	  ...
	  sprintf_s(szCurrentDir_vnclangdll, "%s\\languages\\vnclang_%s.dll", szCurrentDir, savedLanguage);
	  ...
	  if (hLangDLL) {
		  ...
		  sprintf_s(szCurrentDir_vnclangdll, "%s\\vnclang_%s.dll", szCurrentDir, savedLanguage);
...
void ReloadLanguage(const char* langCode)
{
	...
	if (GetModuleFileName(NULL, exePath, MAX_PATH)) {
		...
		if (lastSlash) {
			*lastSlash = '\0';
			...
			if (_stricmp(langCode, "en") == 0) {
				m_hInstResDLL = hInstance;
			}
			else {
				// Try to load from languages subfolder first
				sprintf_s(langDllPath, "%s\\languages\\vnclang_%s.dll", exePath, langCode);
				HMODULE hNewDLL = LoadLibrary(langDllPath);
				...
				if (hNewDLL) {
					...
					sprintf_s(langDllPath, "%s\\vnclang_%s.dll", exePath, langCode);
					hNewDLL = LoadLibrary(langDllPath);
	...
	LoadString(m_hInstResDLL, IDS_I2, sz_I2, 64 -1);
	LoadString(m_hInstResDLL, IDS_I3, sz_I3, 64 -1);
	LoadString(m_hInstResDLL, IDS_I4, sz_I4, 64 -1);
	LoadString(m_hInstResDLL, IDS_J1, sz_J1, 64 -1);
	LoadString(m_hInstResDLL, IDS_J2, sz_J2, 64 -1);
	LoadString(m_hInstResDLL, IDS_K1, sz_K1, 64 -1);
	LoadString(m_hInstResDLL, IDS_K2, sz_K2, 64 -1);
	LoadString(m_hInstResDLL, IDS_K3, sz_K3, 64 -1);
	LoadString(m_hInstResDLL, IDS_L1, sz_L1, 64 -1);
	LoadString(m_hInstResDLL, IDS_L2, sz_L2, 64 -1);
	LoadString(m_hInstResDLL, IDS_L3, sz_L3, 64 -1);
	LoadString(m_hInstResDLL, IDS_L4, sz_L4, 64 -1);
	...
	LoadString(m_hInstResDLL, IDS_L54, sz_L54, 64 -1);
	LoadString(m_hInstResDLL, IDS_L55, sz_L55, 64 -1);
	LoadString(m_hInstResDLL, IDS_L56, sz_L56, 128 -1);
	LoadString(m_hInstResDLL, IDS_L57, sz_L57, 64 -1);
	LoadString(m_hInstResDLL, IDS_L58, sz_L58, 64 -1);
	LoadString(m_hInstResDLL, IDS_L59, sz_L59, 64 -1);
	LoadString(m_hInstResDLL, IDS_L60, sz_L60, 64 -1);
	LoadString(m_hInstResDLL, IDS_L61, sz_L61, 128 -1);
	LoadString(m_hInstResDLL, IDS_L62, sz_L62, 64 -1);
	LoadString(m_hInstResDLL, IDS_L63, sz_L63, 64 -1);
	LoadString(m_hInstResDLL, IDS_L64, sz_L64, 64 -1);
	LoadString(m_hInstResDLL, IDS_L65, sz_L65, 64 -1);
	...
	LoadString(m_hInstResDLL, IDS_L89, sz_L89, 64 -1);
	LoadString(m_hInstResDLL, IDS_L90, sz_L90, 64 -1);
	LoadString(m_hInstResDLL, IDS_L91, sz_L91, 128 -1);
	LoadString(m_hInstResDLL, IDS_L92, sz_L92, 128 -1);
	LoadString(m_hInstResDLL, IDS_L93, sz_L93, 64 -1);
	LoadString(m_hInstResDLL, IDS_M1, sz_M1, 128 -1);
	LoadString(m_hInstResDLL, IDS_M2, sz_M2, 64 -1);
	LoadString(m_hInstResDLL, IDS_M3, sz_M3, 64 -1);
	LoadString(m_hInstResDLL, IDS_M4, sz_M4, 64 -1);
	LoadString(m_hInstResDLL, IDS_M5, sz_M5, 64 -1);
	LoadString(m_hInstResDLL, IDS_N1, sz_N1, 64 -1);
	LoadString(m_hInstResDLL, IDS_N2, sz_N2, 64 -1);
	LoadString(m_hInstResDLL, IDS_N3, sz_N3, 64 -1);
	LoadString(m_hInstResDLL, IDS_N4, sz_N4, 64 -1);
	LoadString(m_hInstResDLL, IDS_N5, sz_N5, 64 -1);
	LoadString(m_hInstResDLL, IDS_N6, sz_N6, 64 -1);
	LoadString(m_hInstResDLL, IDS_N7, sz_N7, 64 -1);
	LoadString(m_hInstResDLL, IDS_N8, sz_N8, 64 -1);
	LoadString(m_hInstResDLL, IDS_N9, sz_N9, 64 -1);
	LoadString(m_hInstResDLL, IDS_N10, sz_N10, 64 -1);
	LoadString(m_hInstResDLL, IDS_N11, sz_N11, 64 -1);
	LoadString(m_hInstResDLL, IDS_N12, sz_N12, 64 -1);
	LoadString(m_hInstResDLL, IDS_N13, sz_N13, 64 -1);
	LoadString(m_hInstResDLL, IDS_N14, sz_N14, 64 -1);
}
