...
[Setup]
AppName=Ultr@VNC Release 1.0.0 RC 20
AppVerName=Ultr@VNC Release 1.0.0 RC 20 - Win32
...
Source: driver\install.bat; DestDir: {app}\driver\; Components: server/upgrade
Source: driver\install_silent.bat; DestDir: {app}\driver\; Components: server/upgrade
Source: driver\setupdrv.exe; DestDir: {app}\driver\; Components: server/upgrade
Source: driver\uninstall.bat; DestDir: {app}\driver\; Components: server/upgrade
Source: driver\uninstall_silent.bat; DestDir: {app}\driver\; Components: server/upgrade
Source: driver\vnccom.sys; DestDir: {app}\driver\; Components: server/upgrade
Source: driver\vncdrv.dll; DestDir: {app}\driver\; Components: server/upgrade
Source: driver\vncdrv.inf; DestDir: {app}\driver\; Components: server/upgrade
Source: driver\vncdrv.sys; DestDir: {app}\driver\; Components: server/upgrade
Source: driver\vnchelp.dll; DestDir: {app}\driver\; Components: server/upgrade
Source: driver\license.txt; DestDir: {app}\driver\; Components: server/upgrade
Source: plugin\debug_off.reg; DestDir: {app}\plugin\
Source: plugin\debug_on.reg; DestDir: {app}\plugin\
Source: plugin\Licence.txt; DestDir: {app}\plugin\
Source: plugin\msrc4plugin.dsm; DestDir: {app}\plugin\
Source: plugin\msrc4plugin_noreg.dsm; DestDir: {app}\plugin\
Source: plugin\Readme.txt; DestDir: {app}\plugin\
Source: plugin\testserver.bat; DestDir: {app}\plugin\
Source: plugin\testviewer.bat; DestDir: {app}\plugin\
Source: plugin\Whatsnew.txt; DestDir: {app}\plugin\
...
Name: {group}\Ultr@VNC Driver\Install Driver; FileName: {app}\driver\setupdrv.exe; Parameters: install; WorkingDir: {app}\driver; Components: server
Name: {group}\Ultr@VNC Driver\Remove Driver; FileName: {app}\driver\setupdrv.exe; Parameters: uninstall; WorkingDir: {app}\driver; Components: server
