# French Language Resources for UltraVNC Server

This folder contains the French language resource files for the UltraVNC Server application.

## Files Included

### Resource Files (Ready for Translation)
- `winvnc.rc` - Main French resource script with dialogs, menus, and string tables
- `UltraVNC_Server_language_french.vcxproj` - Visual Studio project file for building the French DLL
...
Build the project to create the French language DLL:
- Project file: `UltraVNC_Server_language_french.vcxproj`
- Output DLL: `winvnclang_french.dll`
- Resource reference: `winvnc.rc`

## Usage

When built, the resulting DLL can be loaded by UltraVNC Server to provide French interface:
```cpp
