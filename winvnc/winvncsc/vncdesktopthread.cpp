			...
			if (	m_desktop->m_displaychanged ||									//WM_DISPLAYCHANGE
					...
					) 
					{
						...
						//*******************************************************
						{
							...
							//*******************************************************
							if (m_desktop->m_displaychanged || !vncService::InputDesktopSelected() || m_desktop->m_hookswitch || (monitor_changed 
#ifdef DRIVER
								&& !m_desktop->m_videodriver
#endif
								))
									{
										...
										if (fHookDriverWanted
#ifdef DRIVER
											&& m_desktop->m_videodriver == NULL
#endif
											)
											{
