...
const char winvncId[]		= "-id";
const char winvncplugin[]	= "-plugin";
const char winvncPassword[] = "-password";
const char winvncNoRegistry[] = "-noregistry";
const char winvncNoTrayicon[] = "-notrayicon";
const char winvncReadonly[] = "-readonly";
const char winvncUsername[] = "-username";
#endif
...
// Usage string
const char winvncUsageText[]		= "winvnc [-run] [-kill] [-autoreconnect] [-connect host[:display]] [-connect host[::port]] [-install] [-installs] [-remove] [-settings] [-defaultsettings] [-about]\n";
