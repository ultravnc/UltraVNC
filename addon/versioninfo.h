...
#define STR_FILEVERSION XSTR(STR_VERSION)
#define STR_PRODUCTVERSION XSTR(STR_VERSION)
#define STR_COPYRIGHT "Copyright © 2002-2024 UltraVNC Team Members. All Rights Reserved."
#define STR_SPECIALBUILD "v" XSTR(STR_MAINVER) " ReleaseCandidate " XSTR(STR_RC_VERSION)
#if isRC == 1
